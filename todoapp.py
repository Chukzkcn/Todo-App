...
def inputError():
    if enterTaskField.get() == "":
        messagebox.showinfo("input Erorr","Provide above your statement")
        return 0
    return 1
def inserTask():
    global counter
...
if __name__=="__main__":
    ...
    enterTask = Label(root,text="Enter your task here",bg='light green',fg="black",font=("arial",10,"bold"))
    enterTaskField = Entry(root,width=50)
    submit = Button(root,text="submit",bg='light green',fg="black",command=inserTask)
